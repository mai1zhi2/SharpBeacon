    ...
    public static class Win32
    {
        ...
        public static class Advapi32
        {
            ...
            public static extern Boolean AdjustTokenPrivileges(
                ...
                ref Win32.WinNT._TOKEN_PRIVILEGES NewState,
                UInt32 BufferLengthInBytes,
                ref Win32.WinNT._TOKEN_PRIVILEGES PreviousState,
            ...
            public static extern bool CreateProcessWithLogonW(
                ...
                ref Win32.ProcessThreadsAPI._STARTUPINFO startupInfo,
                out Win32.ProcessThreadsAPI._PROCESS_INFORMATION processInformation
            );
            ...
            public static extern Boolean DuplicateTokenEx(
                ...
                UInt32 dwDesiredAccess,
                ref Win32.WinBase._SECURITY_ATTRIBUTES lpTokenAttributes,
                Win32.WinNT._SECURITY_IMPERSONATION_LEVEL ImpersonationLevel,
            ...
            public static extern bool LogonUserA(
                ...
                string lpszDomain,
                string lpszPassword,
                Win32.Advapi32.LOGON_TYPE dwLogonType,
                Win32.Advapi32.LOGON_PROVIDER dwLogonProvider,
                out IntPtr phToken
            );
            ...
            public static extern bool CreateProcessWithTokenW(
                IntPtr hToken,
                Win32.Advapi32.LOGON_FLAGS dwLogonFlags,
                ...
                out Win32.ProcessThreadsAPI._PROCESS_INFORMATION lpProcessInfo
            );
            ...
            public static extern bool LookupAccountSid(
                ...
                out Win32.WinNT._SID_NAME_USE peUse
                );

        }

        public static class Ntdll32 
        {
            ...
            public static extern Int32 NtSetInformationToken(
                ...
                ref Win32.WinNT._TOKEN_MANDATORY_LABEL TokenInformation,
                Int32 TokenInformationLength
            );

            [DllImport("ntdll.dll", SetLastError = true)]
            public static extern Native.NTSTATUS NtCreateSection(
            ...
            [DllImport("ntdll.dll", SetLastError = true)]
            public static extern Native.NTSTATUS NtMapViewOfSection(
            ...
            [DllImport("ntdll.dll", SetLastError = true)]
            public static extern Native.NTSTATUS NtUnmapViewOfSection(
                IntPtr hProc,
                IntPtr baseAddr
            );
...
#pragma warning restore 0618
        ...
        public static IntPtr VirtualAllocEx(
            ...
            IntPtr lpAddress,
            uint dwSize,
            Win32.Kernel32.AllocationType flAllocationType,
            Win32.Kernel32.MemoryProtection flProtect)
        {
            // Craft an array for the arguments
            object[] funcargs =
            {
